...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-10">
			...
			<h3>BookId:BKCO01</h3>
			<h3>Subject:Computer Organization & Architecture</h3>
			<h3>Title:The Essentials of Computer Organization & Architecture</h3>
			<h3>Authors Name:Linda null & Julia Lobur</h3>
			<h3>Edition:4</h3>
