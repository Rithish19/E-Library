...
<div class="container-fluid">
  <div class="row content">
   ...
   <ul class = "dropdown-menu" role = "menu" aria-labelledby = "dropdownMenu1">
      <li role = "presentation">
         <a role = "menuitem" tabindex = "-1" href = "ml.jsp">MachineLearning</a>
      </li>
      
      <li role = "presentation">
         <a role = "menuitem" tabindex = "-1" href = "c.jsp">C - programming</a>
      </li>
   </ul>
...
<div class="w3-row-padding w3-margin-top">
  <div class="w3-third">
    <div class="w3-card">
     <a href="ma1.jsp" ><img src="ml1.jpg" style="width:100% height=50%"></a>
  ...
  <div class="w3-third">
    <div class="w3-card">
      <a href="ma2.jsp"><img src="ml2.jpg" style="width:100% height=50%"></a>
      <div class="w3-container">
      </div>
    </div>
  </div>
  ...
  <div class="w3-third">
    <div class="w3-card">
      <a href="ma3.jsp"><img src="ml3.jpg" style="width:100%"></a>
      <div class="w3-container">
      </div>
    </div>
  </div>
